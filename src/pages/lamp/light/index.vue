<template>
  <div class="content-right">
    ...
    <el-table
      ...
      <el-table-column label="开关状态"><span slot-scope="scope">{{scope.row.switchstate | switchStateNameConverter}}</span></el-table-column>
      <el-table-column label="亮度"><span slot-scope="scope">{{scope.row.brightness == 255 ? '控制异常' : scope.row.brightness + '%'}}</span></el-table-column>
