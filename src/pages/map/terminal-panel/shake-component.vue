<template>
  <div class="control-panel">
    <div class="panel-title"><span class="title">振动检测ID:{{detail.sn}}</span></div>
    <div class="panel-control-body">
      <div class="panel-control-item clearfix">
        <div class="panel-img">
          <img src="../../../assets/map/shake-right.png">
        </div>
      </div>
    </div>
